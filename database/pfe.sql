...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 07 mars 2019 à 23:19
...
(20, 'others', 'theatre', 'casablanca', 'Ecole superieur de casablanca route el jadida', '20.jpg',13 ),
(21, 'others', 'musique', 'casablanca', 'Ecole superieur de casablanca route el jadida', '21.jpg', 13),
(22, 'others', 'football', 'casablanca', 'Ecole superieur de casablanca route el jadida', '22.jpg', 13),
(22, 'others', 'musculation', 'casablanca', 'Ecole superieur de casablanca route el jadida', '23.jpg', 13),
(23, 'others', 'poesie', 'casablanca', 'Ecole superieur de casablanca route el jadida', '24.jpg',13 );
...
(3, 'meriem', 'nasih', 'casablanca', 'meriem@gmail.com', '123456789', '123456789', 'user', '2019-03-01 12:56:03', 0, '0666666666');
...
--
ALTER TABLE `formulaire`
  ADD CONSTRAINT `id_fil_22` FOREIGN KEY (`id_fil`) REFERENCES `filiere` (`id_fil`) ON DELETE CASCADE ON UPDATE CASCADE,
