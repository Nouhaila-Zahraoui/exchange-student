...
--
-- Hôte : 127.0.0.1
-- Généré le :  ven. 08 mars 2019 à 16:27
...
--
-- AUTO_INCREMENT pour la table `prestateurs`
--
ALTER TABLE `prestateurs`
  MODIFY `id_prest` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `accomodation`
  ADD CONSTRAINT `id_prest_4` FOREIGN KEY (`id_prest`) REFERENCES `prestateurs` (`id_prest`) ON DELETE CASCADE ON UPDATE CASCADE;
